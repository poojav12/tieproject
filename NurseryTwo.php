...
<div class="jumbotron layer" style="background-color:#F8F8FF;max-height: 150px;">
  <div class="overlay container row col-md-8 col-md-offset-2" style="margin-left: 0px">
   <h2 style="font-size: 50px; font-family: 'Gruppo';text-align: left;margin-left: 0px;padding-bottom: 60px; color:#66CC66">Richard's Plant Home And Nursery</h2><br>
  </div>  
...
<div id="backdrop" style="margin-top: 0px;background: url(css/WebsiteImages/overlay-green.jpg) fixed rgba(39,62,84,0.82);max-width: 100%">
  <div id="slideshow">
   ...
   <div>
     <img src="css/WebsiteImages/n3.jpg" style="opacity:0.7" height=300 width=600>
   </div>
   <div>
...
<center>
  <div style="align-self: center;background-color: #99FF99;padding-top:-7px; background-size: cover;">
    ...
    <div class="image2" style="width:25vw; height: 25vw; margin-right: 0.2vw">
      <img src="css/ProductImages/iris.jpg" width="60%" height="60%" style="border-radius: 50%; border: 4px solid #66CC66; opacity: 0.87"><b><h1 style="font-size: 1.5vw;">Purples<br>Iris</h1></b> 
    </div>
    <div class="image2"style="width:25vw; height: 25vw; margin-right: 0.2vw">
      <img src="css/ProductImages/Pansy.jpg" width="60%" height="60%" style="border-radius: 50%; border: 4px solid #66CC66; opacity: 0.87"><b><h1 style="font-size: 1.5vw;">Hibiscus<br>Pansy</h1></b> 
    </div>
    <div class="image2" style="width:25vw; height: 25vw; margin-right: 0.2vw">
      <img src="css/ProductImages/looper.jpg" width="60%" height="60%" style="border-radius: 50%; border: 4px solid #66CC66; opacity: 0.87"><b><h1 style="font-size: 1.5vw;">Power<br>looper</h1></b> 
    </div>
    <br><br>
  </div>
  </center>
...
Hill House Nursery And Plant Care Inc.</p>
  ...
  <div style="margin-top:2%; margin-left: 2%; margin-right: 4%; float:left; background-color: white; border-radius: 4%; margin-bottom: 40px">
    <div style="width:600px; height:650px; text-align: center; box-shadow: 3px solid black; border-radius: 4%" >
        ...
        $sql="SELECT * FROM addition inner join product on addition.Pid=product.Pid WHERE NId=2";
