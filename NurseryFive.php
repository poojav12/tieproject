...
<div class="jumbotron layer" style="background-color:#F8F8FF;max-height: 150px;">
  <div class="overlay container row col-md-8 col-md-offset-2" style="margin-left: 0px">
   <h2 style="font-size: 50px; font-family: 'Gruppo';text-align: left;margin-left: 0px;padding-bottom: 60px; color:#FF6633">The Norton Plant Place & Compound</h2><br>
  </div>  
  <p style="margin-bottom: 0px; margin-top: 20px">
<i class="fa fa-twitter" style="color: #FF6633; font-size: 25px; border: 2px double #FF6633; margin-left: 160px; padding-bottom: 0px"></i>        
<i class="fa fa-facebook" style="color:#FF6633; font-size: 25px; padding-left: 5px; padding-right: 5px; border: 2px double #FF6633; margin-left: 20px; padding-bottom: 0px;"></i>       
<i class="fa fa-flickr" style="color: #FF6633; font-size: 25px; border: 2px double #FF6633; padding-left: 2px; padding-right: 2px;margin-left: 20px; padding-bottom: 0px"></i> 
<i class="fa fa-instagram" style="color: #FF6633; font-size: 25px; border: 2px double #FF6633;  padding-left: 2px; padding-right: 2px; margin-left: 20px; padding-bottom: 0px"></i>  
      </p> 
<div id="backdrop" style="margin-top: 0px;background: url(css/WebsiteImages/orange.jpg) fixed rgba(39,62,84,0.82);max-width: 100%">
  <div id="slideshow">
   <div>
     <img src="css/WebsiteImages/n9.jpg" style="opacity:0.7" height=300 width=600>
   </div>
   <div>
     <img src="css/WebsiteImages/n10.jpg" style="opacity:0.7" height=300 width=600>
   </div>
   <div>
     <img src="css/WebsiteImages/n11.jpg" style="opacity:0.7" height=300 width=600>
   </div>
   <div>
     <img src="css/WebsiteImages/n12.jpg" style="opacity:0.7" height=300 width=600>
   </div> 
</div>
</div>
...
<center>
  <div style="align-self: center;background-color: #FF9966;padding-top:-7px; background-size: cover;">
      <h2 style="font-size: 40px; font-family: 'Gruppo'">Our New Variety</h2>
      <hr style="background-color: #FF6633">
   
    <div class="image2" style="width:25vw; height: 25vw; margin-right: 0.2vw">
      <img src="css/ProductImages/car.jpg" width="60%" height="60%" style="border-radius: 50%; border: 4px solid #FF6633; opacity: 0.87"><b><h1 style="font-size: 1.5vw;">Pink<br>Carnation</h1></b> 
    </div>
    <div class="image2"style="width:25vw; height: 25vw; margin-right: 0.2vw">
      <img src="css/ProductImages/pruner.jpg" width="60%" height="60%" style="border-radius: 50%; border: 4px solid #FF6633; opacity: 0.87"><b><h1 style="font-size: 1.5vw;">Garden<br>Pruner</h1></b> 
    </div>
    <div class="image2" style="width:25vw; height: 25vw; margin-right: 0.2vw">
      <img src="css/ProductImages/trowel.jpg" width="60%" height="60%" style="border-radius: 50%; border: 4px solid #FF6633; opacity: 0.87"><b><h1 style="font-size: 1.5vw;">Garden<br>Trowel</h1></b> 
    </div>
    <br><br>
  </div>
  </center>
  ...
  <div style="margin-top:2%; margin-left: 2%; margin-right: 4%; float:left; background-color: white; border-radius: 4%; margin-bottom: 40px">
    <img src="http://sunvalleyomaha.com/wp-content/uploads/2016/01/plant-nursery.jpg" width="500px" height="800px" class="img-thumbnail" position=absolute float=left style="border: 1px solid #FF6633; opacity: 0.9">
  ...
  <div style="margin-top:2%; margin-left: 2%; margin-right: 4%; float:left; background-color: white; border-radius: 4%; margin-bottom: 40px">
    <div style="width:600px; height:650px; text-align: center; box-shadow: 3px solid black; border-radius: 4%" >
                  <div style="font-size: 20px; text-align: center; font-family: 'Gruppo';padding:5px">
                    <h1 style="color: #FF6633; font-size: 45px; padding-left: 50px; font-weight: bold">Available Products<br> In This Nursery</h1><br>
        ...
        $sql="SELECT * FROM addition inner join product on addition.Pid=product.Pid WHERE NId=5";
