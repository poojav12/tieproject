...
<nav id="menu" class="navbar navbar-default navbar-fixed-top" style="width:100%;padding:0%;background-color: white;background-size: cover;">
  <div class="container" style="width:100%;padding:0%; float:left"> 
    ...
    <div class="menu col-1 col-m-1 col-n-2" style="border-left-style: none;padding-left: 0px;"><b style="width: 100%;border-left-style: none;padding-left: 0px;"><a href="HomePage.php" style="text-decoration: none; color: white;">HOME</a></b></div>
<div class="menu col-15 col-m-15 col-n-2"><b style="width: 100%;"><a href="plantsMain (1).php" style="text-decoration: none; color: white;">PLANTS</a></b></div> 
  <div class="menu col-25 col-m-25 col-n-5"><b style="width: 100%;">SEASONAL</b></div>
          <div class="menu col-1 col-m-1 col-n-15"><b style="width: 100%;"><a href="ToolPage (3).html" style="text-decoration: none; color: white;">TOOLS</a></b></div>
  <div class="menu col-1 col-m-1 col-n-15"><b style="width: 100%;"><a href="TipsPage.html" style="text-decoration: none; color: white;">TIPS</a></b></div>
 <div class="menu col-15 col-m-15 col-n-3"><b style="width: 100%;"><a href="NurseryPage.php" style="text-decoration: none; color: white;">NURSERIES</a></b></div>

  <div class="menu col-15 col-m-15 col-n-3"  ><b style="width: 100%;"><a href="SignUpForm.php" style="text-decoration: none; color: white;">SIGN UP</a></b></div>
...
<div class="menu two two1" style="border-left-style: none; float: right;padding-top: 17px;padding-bottom: 0px;"><a href="#"><div style="float: right;padding-right: 22px;" ><img src="https://openclipart.org/image/2400px/svg_to_png/247320/abstract-user-flat-4.png" width="30"  style="background-color: black;border-radius:50%;border: 1px solid white;"></div><br><div style="clear: right; float: right;"><a href="#">Sign-Up</a></div></a></div>
</div>
</div>
</nav>
<header id="header">
...
<div class="jumbotron layer" style="background-color:#F8F8FF;max-height: 150px;">
  <div class="overlay container row col-md-8 col-md-offset-2" style="margin-left: 0px">
   <h2 style="font-size: 50px; font-family: 'Gruppo';text-align: left;margin-left: 0px;padding-bottom: 60px; color:#FF6699">Golden Plant Care Nursery</h2><br>
  </div>  
  <p style="margin-bottom: 0px; margin-top: 20px">
<i class="fa fa-twitter" style="color: #FF6699; font-size: 25px; border: 2px double #FF6699; margin-left: 160px; padding-bottom: 0px"></i>        
<i class="fa fa-facebook" style="color:#FF6699; font-size: 25px; padding-left: 5px; padding-right: 5px; border: 2px double #FF6699; margin-left: 20px; padding-bottom: 0px;"></i>       
<i class="fa fa-flickr" style="color: #FF6699; font-size: 25px; border: 2px double #FF6699; padding-left: 2px; padding-right: 2px;margin-left: 20px; padding-bottom: 0px"></i> 
<i class="fa fa-instagram" style="color: #FF6699; font-size: 25px; border: 2px double #FF6699;  padding-left: 2px; padding-right: 2px; margin-left: 20px; padding-bottom: 0px"></i>  
      </p> 
<div id="backdrop" style="margin-top: 0px;background: url(css/WebsiteImages/pink.jpg) fixed rgba(39,62,84,0.82);max-width: 100%">
  <div id="slideshow">
   <div>
     <img src="css/WebsiteImages/n5.jpg" style="opacity:0.7" height=300 width=600>
   </div>
   <div>
   ...
   <div>
     <img src="css/WebsiteImages/n8.jpg" style="opacity:0.7" height=300 width=600>
   </div> 
</div>
</div>
...
<center>
  <div style="align-self: center;background-color: #FFCCCC;padding-top:-7px; background-size: cover;">
    ...
    <div class="image2" style="width:25vw; height: 25vw; margin-right: 0.2vw">
      <img src="css/ProductImages/iris.jpg" width="60%" height="60%" style="border-radius: 50%; border: 4px solid #FF6699; opacity: 0.87"><b><h1 style="font-size: 1.5vw;">Purples<br>Iris</h1></b> 
    </div>
    <div class="image2"style="width:25vw; height: 25vw; margin-right: 0.2vw">
      <img src="css/ProductImages/garden-fork.jpg" width="60%" height="60%" style="border-radius: 50%; border: 4px solid #FF6699; opacity: 0.87"><b><h1 style="font-size: 1.5vw;">Garden<br>Fork</h1></b> 
    </div>
    <div class="image2" style="width:25vw; height: 25vw; margin-right: 0.2vw">
      <img src="css/ProductImages/looper.jpg" width="60%" height="60%" style="border-radius: 50%; border: 4px solid #FF6699; opacity: 0.87"><b><h1 style="font-size: 1.5vw;">Power<br>looper</h1></b> 
    </div>
    <br><br>
  </div>
  </center>
  ...
  <div style="margin-top:2%; margin-left: 2%; margin-right: 4%; float:left; background-color: white; border-radius: 4%; margin-bottom: 40px">
    <img src="http://sunvalleyomaha.com/wp-content/uploads/2016/01/plant-nursery.jpg" width="500px" height="800px" class="img-thumbnail" position=absolute float=left style="border: 1px solid #FF6699; opacity: 0.9">
  ...
  <div style="margin-top:2%; margin-left: 2%; margin-right: 4%; float:left; background-color: white; border-radius: 4%; margin-bottom: 40px">
    <div style="width:600px; height:650px; text-align: center; box-shadow: 3px solid black; border-radius: 4%" >
    	            <div style="font-size: 20px; text-align: center; font-family: 'Gruppo';padding:5px">
    	            	<h1 style="color: #FF6699; font-size: 45px; padding-left: 50px; font-weight: bold">Available Products<br> In This Nursery</h1><br>
        ...
        $sql="SELECT * FROM addition inner join product on addition.Pid=product.Pid WHERE NId=3";
